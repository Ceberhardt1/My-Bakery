...
import { faEnvelopeOpen, faMapLocation } from '@fortawesome/free-solid-svg-icons'
        ...
        <div>
                ...
                <div className="container">
                    <div className="row gx-5">
                        <div className="col-lg-4 col-md-6 mb-lg-n5">
                            <div
                                className="d-flex flex-column align-items-center justify-content-center text-center h-100 bg-primary border-inner p-4"
                            >
                            ...
                            <div className="row gx-5">
                                <div className="col-lg-4 col-md-12 pt-5 mb-5">
                                    ...
                                    <div className="d-flex mb-2">
                                        <FontAwesomeIcon icon={faMapLocation} className="bi bi-geo-alt text-primary me-2"/>
                                        <p className="mb-0">123 Street, New York, USA</p>
                                    </div>
                                    <div className="d-flex mb-2">
                                        <FontAwesomeIcon icon={faEnvelopeOpen} className="bi bi-envelope-open text-primary me-2"/>
                                        <p className="mb-0">info@example.com</p>
                                    </div>
                                    <div className="d-flex mb-2">
                                    <FontAwesomeIcon icon={faPhone} className="bi bi-telephone text-primary me-2"/>
                                    ...
                                    <div className="d-flex mt-4">
                                        <a
                                            ...
                                            href="#"
                                        ><FontAwesomeIcon icon={faTwitter} className="fab fa-twitter fw-normal"/>
                                        </a>
                                        <a
                                            className="btn btn-lg btn-primary btn-lg-square border-inner rounded-0 me-2"
                                            href="#"
                                        ><FontAwesomeIcon icon={faFacebook} className="fab fa-facebook-f fw-normal"/>
                                        </a>
                                        <a
                                            className="btn btn-lg btn-primary btn-lg-square border-inner rounded-0 me-2"
                                            href="#"
                                        ><FontAwesomeIcon icon={faLinkedin} className="fab fa-linkedin-in fw-normal"/>
                                        </a>
                                    </div>
                                </div>
                                <div className="col-lg-4 col-md-12 pt-0 pt-lg-5 mb-5">
                                    ...
                                    <div className="d-flex flex-column justify-content-start">
                                        ...
                                        >
                                        <a className="text-secondary mb-2" href="#"
                                        ><i className="bi bi-arrow-right text-primary me-2"></i>Meet The
                                            Team</a
                                        >
                                        <a className="text-secondary mb-2" href="#"
            ...
            >
                <div className="container text-center">
                    <p className="mb-0">
                        &copy;
                        <a className="text-white border-bottom" href="#">Your Site Name</a>. All
                        Rights Reserved.
